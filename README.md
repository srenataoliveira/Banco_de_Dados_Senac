...
(ID_Cliente INT PRIMARY KEY AUTO_INCREMENT, Nome VARCHAR(150) NOT NULL, cpf VARCHAR(150) NOT NULL, data_de_nascimento DATE NOT NULL, Endereco TEXT, Telefone VARCHAR(20) );
